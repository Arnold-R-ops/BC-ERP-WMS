...
> **2026-08-11 本机凭证门禁更新：通过。** 历史数据库密码已在数据库端轮换并验证失效，应用已切换到非超级用户 `wms_app`。该结论只覆盖当前本机环境；其他部署环境仍必须分别执行凭证轮换和最小权限验证。详见 `docs/P2_DATABASE_CREDENTIAL_ROTATION_2026-08-11.md`。
